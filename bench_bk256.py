#!/usr/bin/env python3
"""Test BLOCK_K=256 and other configs for large-K workloads."""
import torch
...
CONFIGS = [
    ...
    {"BLOCK_N": 256, "BLOCK_K": 128, "num_warps": 4, "num_stages": 1},
]
